...
To show code as an overlay, we can create syntax-highlighted code images using `carbon_image()`, which uses the [carbonara API](https://github.com/petersolopov/carbonara) to render code with carbon.js styling.
